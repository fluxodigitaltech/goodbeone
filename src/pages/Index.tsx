    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="absolute top-0 left-0 w-full z-50 p-6">
        <div className="container mx-auto flex justify-between items-center">
          <img src="goodbe seu centro de bem estar.png" alt="Goodbe Logo" className="h-10" />
          <button
            onClick={() => setIsModalOpen(true)}
            className="bg-cta text-primary font-black px-6 py-2 rounded-full text-sm uppercase tracking-wider hover:scale-105 transition-transform"
          >
      ...
      <main>
        ...
        <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden bg-primary">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-primary/80 via-primary/40 to-white z-[1]"></div>

          {/* Decorative Pattern Overlay */}
          <div className="absolute inset-0 z-[2] opacity-5 pointer-events-none" style={{ backgroundImage: 'url(gb_element.png)', backgroundSize: '300px' }}></div>
          ...
          <div className="container mx-auto relative z-[10] px-4 text-center">
            <h1 className="text-4xl md:text-7xl font-black text-white mb-6 leading-[1.1]">
              GoodBe.<br />
              <span className="text-cta italic">Um novo jeito de cuidar<br />do corpo e da mente.</span>
            </h1>
            <p className="text-lg md:text-xl text-white/90 mb-10 max-w-3xl mx-auto font-medium">
            ...
            <button
              onClick={() => setIsModalOpen(true)}
              className="bg-cta text-primary font-black uppercase tracking-widest px-10 py-5 rounded-2xl hover:scale-105 transition-all shadow-[0_0_50px_rgba(217,255,13,0.3)] group"
            >
        ...
        <section className="py-20 bg-primary relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="inline-block bg-white/10 backdrop-blur-md border border-white/20 px-8 py-4 rounded-2xl">
                <p className="text-white font-bold text-lg md:text-xl tracking-wide">
                  Quando o exercício é leve, você consegue repetir.<br className="hidden md:block" /> E o que você repete, <span className="text-cta">transforma.</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-gray-50 relative">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-black text-primary text-center mb-16">
              Tudo o que você precisa para <br className="md:hidden" />
              <span className="text-secondary">se sentir bem</span>
            </h2>
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 md:gap-8">
              {modalities.map((m) => (
                <div key={m.name} className="bg-white px-2 py-8 rounded-3xl border-b-8 border-highlight shadow-xl hover:-translate-y-3 transition-all duration-300 text-center group">
                  <div className="w-24 h-24 md:w-28 md:h-28 mx-auto mb-6 rounded-full overflow-hidden border-4 border-gray-100 group-hover:border-secondary transition-colors bg-white p-2">
                    <img
                      src={m.img}
                      alt={m.name}
                  ...
                  <h3 className="font-black text-primary tracking-tight text-xs md:text-sm leading-tight uppercase px-1">{m.name}</h3>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 bg-white overflow-hidden relative">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-secondary font-bold mb-12">
              você precisa sentir.
            </p>
            <button
              onClick={() => setIsModalOpen(true)}
              className="bg-cta text-primary font-black uppercase tracking-widest px-10 py-5 rounded-2xl hover:scale-105 transition-all shadow-lg"
            >
              Agende sua primeira experiência
            </button>
          </div>
      ...
      <footer className="bg-primary pt-24 pb-12 text-center text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <button
            onClick={() => setIsModalOpen(true)}
            className="bg-cta text-primary font-black uppercase tracking-widest px-12 py-6 rounded-2xl hover:scale-105 transition-all shadow-2xl mb-24"
          >
            Viver a experiência GoodBe
          </button>
          <div className="border-t border-white/10 pt-16 flex flex-col items-center">
            <img src="goodbe seu centro de bem estar.png" alt="Logo" className="h-14 mb-8" />
            <p className="font-black text-xl mb-3 tracking-tight">Goodbe. Bem-estar que funciona.</p>
          </div>
          <p className="mt-20 text-xs text-white/30 uppercase tracking-[0.2em]">
